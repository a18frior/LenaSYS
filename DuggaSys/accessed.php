	...
	<!-- content START -->
		...
		<div id="newbutton">
			<?php
				...
				echo "<input id='searchinput' type='text' name='search' placeholder='Search..' onkeyup='searchterm=encodeHTML(document.getElementById(\"searchinput\").value);searchKeyUp(event);myTable.renderTable();'> ";
