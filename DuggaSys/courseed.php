...
<body>
    ...
    <div class='loginBox' style='width:464px;'>
    		...
    		<div style='padding:5px;'>
    			...
    			<div class='inputwrapper'><span style='font-style:italic;color:rgba(0,0,0,0.6)'>Read Only:</span>
				<input type="checkbox" name='readonly' id='readonly' value="no" title='Disables uploads/submits. Usefull for active backup servers.'  disabled></select></div>
    		</div>
    		<div style='padding:5px;'>
