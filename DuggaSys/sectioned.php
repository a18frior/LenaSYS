		...
		<div class='loginBox' style='width:460px;'>
			...
			<div style='padding:5px;'>
				...
				<div id='inputwrapper-type' class='inputwrapper'>
					...
					<div id='inputwrapper-deadline'><span>Set Deadline:</span><span><input class type='date' id='setDeadlineValue' value='' /><select style='width:55px;' id='deadlinet'></select><select style='width:55px;' id='deadlinem'></select></span></div>
