...
//         ctx.strokeStyle = (this.isSelected || this.isHovered) ? "#F82" : this.properties['strokeColor'];
...
//         //Highlighting points when isSelected, makes it easier to resize
//         if(this.isSelected && this.symbolkind != symbolKind.text) {
//             ctx.beginPath();
...
//     this.isSelected = true;           // An organized path can contain several sub-path, each of which must be organized
