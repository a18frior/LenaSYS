...
function process() {
	...
	dstr += "<div class='checkbox-dugga'><input name='sortcol' type='radio' class='sortradio' onclick='sorttype(0)' value='0' id='sortcol0_0'><label class='headerlabel' for='sortcol0_0' onclick='myTable.setNameColumn(\"" + colnameArr[0] + "\"); myTable.toggleSortStatus(\"" + col + "\",0) >Firstname</label></div>";
...
function renderSortOptions(col, status, colname) {
	str = "";
	if (status == -1) {
		if (col == "FnameLnameSSN"||"Firstname") {
