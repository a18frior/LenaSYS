...
function process() {
	...
	dstr += "<div class='checkbox-dugga'><input name='sortcol' type='radio' class='sortradio' onclick='myTable.toggleSortStatus(\"" + col + "\",3) value='0' id='sortcol0_0'><label class='headerlabel' for='sortcol0_0' >Firstname </span>" + colname + "</span>";
