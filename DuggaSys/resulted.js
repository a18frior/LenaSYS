...
function process() {
	...
	dstr += "<div class='checkbox-dugga'><input name='sortcol' type='radio' class='sortradio' onclick='sorttype(0)' value='0' id='sortcol0_0'><label class='headerlabel' for='sortcol0_0' onclick='myTable.setNameColumn; myTable.toggleSortStatus' >Firstname</label></div>";
